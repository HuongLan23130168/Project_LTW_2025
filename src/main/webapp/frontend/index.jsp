    ...
    <header class="header">
        <div class="header-top">
            ...
            <div class="header-right">
                <a href="login.jsp">Tra cứu đơn hàng</a>
                <a href="gioithieu.jsp">Giới thiệu</a>
                <a href="contact.jsp">Liên hệ</a>
                <div class="icons">
                    <a href="login.jsp" class="circle"><i class="fa-solid fa-cart-shopping"></i></a>
        ...
        <section class="section" id="gallery">
            ...
            <section class="promo-slider">
                <div class="slider-track">
                    ...
                    <div class="promo-group">
                        ...
                        <div class="promo-main">
                            <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1600&q=80"
                                alt="Loft Harmony 2025">
                            <div class="promo-content">
                                <h2>Bộ sưu tập mới — <span>Loft Harmony 2025</span></h2>
                                <p>
                                    Sự kết hợp hoàn hảo giữa gỗ tự nhiên và thiết kế hiện đại.<br>
                                    Khám phá không gian sống sang trọng, tinh tế và đậm phong cách riêng.
                                </p>
                                <a href="#newProducts" class="promo-btn" id="scrollToProducts">Khám phá ngay</a>
                            </div>
                        </div>
                        ...
                        <div class="promo-side">
                            <div class="promo-small sale-banner">
                                <img src="https://i.pinimg.com/1200x/62/b0/a6/62b0a617dba80a738059855d51c9f04c.jpg"
                                    alt="Giảm giá 30%">
                                <div class="banner-text">
                                    <h3>Giảm giá 30%</h3>
                                    <p>Sofa & Decor hiện đại</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="promo-group">
                        <div class="promo-main">
                            <img src="https://i.pinimg.com/736x/c8/14/f3/c814f390962a33a1f3959cdb6db4323a.jpg"
                                alt="Modern Wood 2025">
                            <div class="promo-content">
                                <h2>BST — <span>Modern Wood 2025</span></h2>
                                <p>
                                    Thiết kế mộc mạc nhưng sang trọng, sử dụng chất liệu tự nhiên thân thiện môi trường.
                                </p>
                                <a href="#newProducts" class="promo-btn">Khám phá ngay</a>
                            </div>
                        </div>

                        <div class="promo-side">
                            <div class="promo-small sale-banner">
                                <img src="https://i.pinimg.com/1200x/94/2c/1f/942c1f141fec13888c4542979cc839ba.jpg"
                                    alt="Decor mới">
                                <div class="banner-text">
                                    <h3>Decor mới</h3>
                                    <p>Phong cách Bắc Âu tinh tế</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="product-grid">
                    <a href="decor.jsp" class="product-card">
                        ...
                        <div class="product-info">
                            <h3>Ghế Sofa</h3>
                            <p>Thiết kế hiện đại, chất liệu da cao cấp mang đến sự sang trọng cho phòng khách.</p>
                        </div>
                    </a>
